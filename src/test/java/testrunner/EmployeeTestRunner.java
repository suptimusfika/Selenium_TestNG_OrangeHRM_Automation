...
public class EmployeeTestRunner extends Setup {
    ...
    @Test(priority = 1, description = "Employee creation will be unsuccessful without valid username")
    ...
    @Test(priority = 2, description = "Employee creation will be unsuccessful without valid password")
    ...
    @Test(priority = 3, description = "Successfully Create employee")
    ...
    @Test(priority = 4, description = "Using valid id, Search employee", groups = "smoke")
    ...
    @Test(priority = 5, description = "Using invalid id, Search employee")
    ...
    @Test(priority = 6, description = "Using valid name, Search employee")
    ...
    @Test(priority = 7, description = "Using invalid name, Search employee")
    ...
    @Test(priority = 8, description = "Log-out Successfully", groups = "smoke")
    ...
    @Test(priority = 9, description = "User should not see The logout option while user is logged in")
